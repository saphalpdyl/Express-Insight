...
import { consolePrint, generateLogFileStream, getFileDirName, getSystemMonthYear } from "./utils.js";
import { DEFAULT_SETTINGS } from "./defaultSettings.js";

import adminHomeRoute from "./routes/adminHomeRoute.js";
import { generateErrorInfo } from "./helpers/generateErrorInfo.js";
import { saveLogErrorEntry, saveLogErrorToDB, initializeDB } from "./helpers/index.js";
...
class ExpressInsight {
  ...
  setupErrorPlugin() {
    // TOOD: Add a configuration for a callback that shows when there is an error
    ...
    this.#app.use((error, req, res, next) => {
      ...
      const logDB = initializeDB(logFolderPath, this.#configuration.dbFileName);
      ...
      saveLogErrorToDB(logDB, errorInfo);
      next();
    })
  }
}
